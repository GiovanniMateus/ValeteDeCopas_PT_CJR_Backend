...
export class LojasController {
  ...
  @UseInterceptors(FileFieldsInterceptor([
    ...
    storage: diskStorage({
      destination: './uploads/lojas', //esse é o destino das  imagens 
  ...
  async create(
    ...
    const lojaData: Partial<CreateLojasDto> = {
      ...
      nome: body.nome,
      descricao: body.descricao || '', //estou passando descrição para caso futuramente esse campo venha existir
    };
